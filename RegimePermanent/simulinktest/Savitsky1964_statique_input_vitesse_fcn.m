...
% Par Charles Khazoom
%% Données
function [tau_e,D_e,P_e,Df_e] = Savitsky1964_statique_input_vitesse_fcn(v,intervalle_tau,CstData)
% coder.extrinsic('bissection_fcn_v_input');
tau_e = 0;D_e =0;Df_e = 0;
...
%% Calculs
[tau_e, D_e,Df_e] = bissection_fcn_v_input(intervalle_tau(1),intervalle_tau(end),0.001,v,CstData);
P_e = D_e*v;
